...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "addsub.autotvin.dat"
	set constFileTvOut       "addsub.autotvout.dat"
	set constFileHdlTvIn     "addsub.autohdltvin.dat"
	set constFileHdlTvOut    "addsub.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
