...
set C_modelArgList {
	...
	{ sa_ba_sa int 32 unused {array 4 { } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "sa_pe_li", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "sa.pe.li","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 1,"step" : 1},{"low" : 0,"up" : 1,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "sa_ba_sa", "interface" : "memory", "bitwidth" : 32, "direction" : "NONE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "sa.ba_sa","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 1,"step" : 1},{"low" : 0,"up" : 1,"step" : 1}]}]}]} ]}
...
set portList { 
	...
	{ sa_ba_sa_q0 sc_in sc_lv 32 signal 9 } 
	{ sa_ba_sa_address1 sc_out sc_lv 2 signal 9 } 
	{ sa_ba_sa_ce1 sc_out sc_logic 1 signal 9 } 
	{ sa_ba_sa_we1 sc_out sc_logic 1 signal 9 } 
	{ sa_ba_sa_d1 sc_out sc_lv 32 signal 9 } 
	{ sa_ba_sa_q1 sc_in sc_lv 32 signal 9 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sa_ba_sa_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "sa_ba_sa", "role": "q0" }} , 
 	{ "name": "sa_ba_sa_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "sa_ba_sa", "role": "address1" }} , 
 	{ "name": "sa_ba_sa_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "sa_ba_sa", "role": "ce1" }} , 
 	{ "name": "sa_ba_sa_we1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "sa_ba_sa", "role": "we1" }} , 
 	{ "name": "sa_ba_sa_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "sa_ba_sa", "role": "d1" }} , 
 	{ "name": "sa_ba_sa_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "sa_ba_sa", "role": "q1" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "4", "EstimateLatencyMax" : "53",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Port" : [
			...
			{"Name" : "sa_ba_sa", "Type" : "Memory", "Direction" : "X"}]}]}
...
set ArgLastReadFirstWriteLatency {
	sa_compute {
		...
		sa_ba_sa {Type X LastRead -1 FirstWrite -1}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4", "Max" : "53"}
	, {"Name" : "Interval", "Min" : "5", "Max" : "54"}
]}
...
set Spec2ImplPortList { 
	...
	sa_ba_sa { ap_memory {  { sa_ba_sa_address0 mem_address 1 2 }  { sa_ba_sa_ce0 mem_ce 1 1 }  { sa_ba_sa_we0 mem_we 1 1 }  { sa_ba_sa_d0 mem_din 1 32 }  { sa_ba_sa_q0 mem_dout 0 32 }  { sa_ba_sa_address1 MemPortADDR2 1 2 }  { sa_ba_sa_ce1 MemPortCE2 1 1 }  { sa_ba_sa_we1 MemPortWE2 1 1 }  { sa_ba_sa_d1 MemPortDIN2 1 32 }  { sa_ba_sa_q1 MemPortDOUT2 0 32 } } }
}
