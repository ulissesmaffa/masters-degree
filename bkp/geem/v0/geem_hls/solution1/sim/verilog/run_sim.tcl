...
if {[file isfile sa_compute.autotvin.dat]} {
	file delete -force sa_compute.autotvin.dat
}

if {[file isfile sa_compute.autotvout.dat]} {
	file delete -force sa_compute.autotvout.dat
}
