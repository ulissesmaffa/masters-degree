...
namespace spec {
  ...
  namespace AxiConf {
    ...
    struct rvCfg {
      enum {
        dataWidth = 32, 
        addrWidth = 8, // Can truncate to get the lower 8 bits, no need for 32 bits.
...
const int DATA_WIDTH = spec::AxiData::axiCfg::dataWidth;
const int MAX_BURST_SIZE = spec::AxiData::axiCfg::maxBurstSize;
