...
entity C_drain_IO_L1_out_boundary_wrapper135 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of C_drain_IO_L1_out_boundary_wrapper135 is 
    ...
    signal select_ln1371_1_fu_310_p3 : STD_LOGIC_VECTOR (3 downto 0);
    signal select_ln1371_1_reg_507 : STD_LOGIC_VECTOR (3 downto 0);
    signal trunc_ln1371_fu_326_p1 : STD_LOGIC_VECTOR (1 downto 0);
    signal trunc_ln1371_reg_512 : STD_LOGIC_VECTOR (1 downto 0);
    signal local_C_V_addr_reg_516 : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal select_ln544_2_fu_448_p3 : STD_LOGIC_VECTOR (3 downto 0);
    signal select_ln544_2_reg_536 : STD_LOGIC_VECTOR (3 downto 0);
    signal add_ln700_3_fu_483_p2 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal data_split_0_V_2_fu_395_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_phi_reg_pp0_iter1_v1_V_reg_181 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_phi_mux_v2_V_6_phi_fu_197_p8 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_phi_reg_pp0_iter1_v2_V_6_reg_194 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_phi_mux_v2_V_5_phi_fu_210_p8 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_phi_reg_pp0_iter1_v2_V_5_reg_207 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal zext_ln321_2_fu_478_p1 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    port map (
        ...
        ce0 => local_C_V_ce0,
        q0 => local_C_V_q0,
        address1 => local_C_V_addr_reg_516,
        ce1 => local_C_V_ce1,
        we1 => local_C_V_we1,
        d1 => local_C_V_d1);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
                ...
                p_054_0_i_i_0_reg_255 <= add_ln700_3_fu_483_p2;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln849_reg_498 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
                p_062_0_i_i_reg_159 <= select_ln1371_1_reg_507;
            elsif (((icmp_ln1000_fu_266_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
                ...
                p_064_0_i_i_0_reg_244 <= select_ln544_2_reg_536;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln849_fu_278_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                local_C_V_addr_reg_516 <= zext_ln321_fu_338_p1(4 - 1 downto 0);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln849_fu_278_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                select_ln1371_1_reg_507 <= select_ln1371_1_fu_310_p3;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln927_fu_416_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp1_stage0_11001))) then
                select_ln544_2_reg_536 <= select_ln544_2_fu_448_p3;
            end if;
        end if;
    end process;
    ...
    add_ln321_fu_472_p2 <= std_logic_vector(unsigned(zext_ln321_1_fu_468_p1) + unsigned(zext_ln929_fu_464_p1));
    add_ln700_3_fu_483_p2 <= std_logic_vector(unsigned(select_ln544_fu_440_p3) + unsigned(ap_const_lv2_1));
    ...
    ap_phi_mux_p_062_0_i_i_phi_fu_163_p4_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, icmp_ln849_reg_498, p_062_0_i_i_reg_159, select_ln1371_1_reg_507)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (icmp_ln849_reg_498 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ap_phi_mux_p_062_0_i_i_phi_fu_163_p4 <= select_ln1371_1_reg_507;
        else 
    ...
    ap_phi_mux_p_064_0_i_i_0_phi_fu_248_p4_assign_proc : process(ap_CS_fsm_pp1_stage0, ap_enable_reg_pp1_iter1, ap_block_pp1_stage0, icmp_ln927_reg_527, p_064_0_i_i_0_reg_244, select_ln544_2_reg_536)
    begin
        if (((icmp_ln927_reg_527 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp1_stage0) and (ap_enable_reg_pp1_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0))) then 
            ap_phi_mux_p_064_0_i_i_0_phi_fu_248_p4 <= select_ln544_2_reg_536;
        else 
    ...
    ap_phi_mux_v1_V_phi_fu_184_p8_assign_proc : process(icmp_ln849_reg_498, trunc_ln1371_reg_512, local_C_V_q0, data_split_0_V_2_fu_395_p1, ap_phi_reg_pp0_iter1_v1_V_reg_181)
    begin
        if ((((icmp_ln849_reg_498 = ap_const_lv1_0) and (trunc_ln1371_reg_512 = ap_const_lv2_0)) or ((icmp_ln849_reg_498 = ap_const_lv1_0) and (trunc_ln1371_reg_512 = ap_const_lv2_1)) or ((icmp_ln849_reg_498 = ap_const_lv1_0) and (trunc_ln1371_reg_512 = ap_const_lv2_2)))) then 
            ...
            ap_phi_mux_v1_V_phi_fu_184_p8 <= data_split_0_V_2_fu_395_p1;
        else 
    ...
    ap_phi_mux_v2_V_5_phi_fu_210_p8_assign_proc : process(icmp_ln849_reg_498, trunc_ln1371_reg_512, local_C_V_q0, data_split_0_V_2_fu_395_p1, ap_phi_reg_pp0_iter1_v2_V_5_reg_207)
    begin
        if (((icmp_ln849_reg_498 = ap_const_lv1_0) and (trunc_ln1371_reg_512 = ap_const_lv2_1))) then 
            ap_phi_mux_v2_V_5_phi_fu_210_p8 <= data_split_0_V_2_fu_395_p1;
            ...
            ap_phi_mux_v2_V_5_phi_fu_210_p8 <= local_C_V_q0(63 downto 32);
        else 
            ap_phi_mux_v2_V_5_phi_fu_210_p8 <= ap_phi_reg_pp0_iter1_v2_V_5_reg_207;
        end if; 
    end process;


    ap_phi_mux_v2_V_6_phi_fu_197_p8_assign_proc : process(icmp_ln849_reg_498, trunc_ln1371_reg_512, local_C_V_q0, data_split_0_V_2_fu_395_p1, ap_phi_reg_pp0_iter1_v2_V_6_reg_194)
    begin
        if (((icmp_ln849_reg_498 = ap_const_lv1_0) and (trunc_ln1371_reg_512 = ap_const_lv2_2))) then 
            ap_phi_mux_v2_V_6_phi_fu_197_p8 <= data_split_0_V_2_fu_395_p1;
            ...
            ap_phi_mux_v2_V_6_phi_fu_197_p8 <= local_C_V_q0(95 downto 64);
        else 
            ap_phi_mux_v2_V_6_phi_fu_197_p8 <= ap_phi_reg_pp0_iter1_v2_V_6_reg_194;
        end if; 
    end process;


    ap_phi_mux_v2_V_phi_fu_223_p8_assign_proc : process(icmp_ln849_reg_498, trunc_ln1371_reg_512, data_split_0_V_2_fu_395_p1, data_split_0_V_fu_349_p1, ap_phi_reg_pp0_iter1_v2_V_reg_220)
    begin
        if (((icmp_ln849_reg_498 = ap_const_lv1_0) and (trunc_ln1371_reg_512 = ap_const_lv2_0))) then 
            ap_phi_mux_v2_V_phi_fu_223_p8 <= data_split_0_V_2_fu_395_p1;
    ...
    ap_phi_reg_pp0_iter1_v2_V_5_reg_207 <= "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
    ap_phi_reg_pp0_iter1_v2_V_6_reg_194 <= "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
    ...
    data_split_0_V_2_fu_395_p1 <= fifo_C_drain_local_in_V_dout;
    ...
    local_C_V_address0_assign_proc : process(ap_CS_fsm_pp1_stage0, ap_block_pp1_stage0, ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_enable_reg_pp0_iter0, ap_enable_reg_pp1_iter0, zext_ln321_fu_338_p1, zext_ln321_2_fu_478_p1)
    begin
        if (((ap_const_boolean_0 = ap_block_pp1_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1))) then 
            local_C_V_address0 <= zext_ln321_2_fu_478_p1(4 - 1 downto 0);
    ...
    local_C_V_d1 <= (((ap_phi_mux_v1_V_phi_fu_184_p8 & ap_phi_mux_v2_V_6_phi_fu_197_p8) & ap_phi_mux_v2_V_5_phi_fu_210_p8) & ap_phi_mux_v2_V_phi_fu_223_p8);
    ...
    tmp_7_fu_330_p3 <= (select_ln1371_fu_302_p3 & tmp_fu_318_p3);
    tmp_8_fu_456_p3 <= (select_ln544_2_fu_448_p3 & ap_const_lv1_0);
    tmp_fu_318_p3 <= select_ln1371_1_fu_310_p3(2 downto 2);
    trunc_ln1371_fu_326_p1 <= select_ln1371_1_fu_310_p3(2 - 1 downto 0);
    zext_ln321_1_fu_468_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(select_ln544_fu_440_p3),6));
    zext_ln321_2_fu_478_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln321_fu_472_p2),64));
    zext_ln321_fu_338_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_7_fu_330_p3),64));
    zext_ln929_fu_464_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_8_fu_456_p3),6));
end behav;
