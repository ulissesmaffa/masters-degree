...
output  [511:0] fifo_A_local_out_V_V_din;
...
reg   [0:0] icmp_ln38_reg_141;
reg    A_V_offset_blk_n;
reg    fifo_A_local_out_V_V_blk_n;
reg    ap_enable_reg_pp0_iter2;
reg   [0:0] icmp_ln38_reg_141_pp0_iter1_reg;
reg   [10:0] t_V_reg_87;
reg   [25:0] A_V_offset1_i_reg_130;
reg    ap_block_state1;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln38_fu_118_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if ((~((real_start == 1'b0) | (1'b0 == A_V_offset_empty_n) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        A_V_offset1_i_reg_130 <= {{A_V_offset_dout[31:6]}};
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln38_reg_141 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if (((icmp_ln38_reg_141 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if ((icmp_ln38_fu_118_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((icmp_ln38_reg_141_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln38_reg_141_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if (((m_axi_A_V_ARREADY == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if (((icmp_ln38_reg_141 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln38_fu_118_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b0)) & ~((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln38_fu_118_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b0)) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((icmp_ln38_reg_141_pp0_iter1_reg == 1'd0) & (fifo_A_local_out_V_V_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((icmp_ln38_reg_141 == 1'd0) & (m_axi_A_V_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((icmp_ln38_reg_141_pp0_iter1_reg == 1'd0) & (fifo_A_local_out_V_V_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((icmp_ln38_reg_141 == 1'd0) & (m_axi_A_V_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((icmp_ln38_reg_141_pp0_iter1_reg == 1'd0) & (fifo_A_local_out_V_V_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((icmp_ln38_reg_141 == 1'd0) & (m_axi_A_V_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_state1 = ((real_start == 1'b0) | (1'b0 == A_V_offset_empty_n) | (ap_done_reg == 1'b1));
end

always @ (*) begin
    ap_block_state10_pp0_stage0_iter1 = ((icmp_ln38_reg_141 == 1'd0) & (m_axi_A_V_RVALID == 1'b0));
end

always @ (*) begin
    ap_block_state11_pp0_stage0_iter2 = ((icmp_ln38_reg_141_pp0_iter1_reg == 1'd0) & (fifo_A_local_out_V_V_full_n == 1'b0));
end
...
assign fifo_A_local_out_V_V_din = fifo_data_V_reg_150;

assign i_V_fu_124_p2 = (t_V_reg_87 + 11'd1);

assign icmp_ln38_fu_118_p2 = ((t_V_reg_87 == 11'd1024) ? 1'b1 : 1'b0);

assign m_axi_A_V_ARADDR = zext_ln33_fu_108_p1;
...
assign m_axi_A_V_ARLEN = 32'd1024;
...
assign zext_ln33_fu_108_p1 = A_V_offset1_i_reg_130;
