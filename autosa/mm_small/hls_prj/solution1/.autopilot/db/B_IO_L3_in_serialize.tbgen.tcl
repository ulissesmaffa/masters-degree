...
set C_modelArgList {
	...
	{ fifo_B_local_out_V_V int 512 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "B_V", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "fifo_B_local_out_V_V", "interface" : "fifo", "bitwidth" : 512, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ fifo_B_local_out_V_V_din sc_out sc_lv 512 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "fifo_B_local_out_V_V_din", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "fifo_B_local_out_V_V", "role": "din" }} , 
