...
set Spec2ImplPortList { 
	C_V { m_axi {  { m_axi_C_V_AWVALID VALID 1 1 }  { m_axi_C_V_AWREADY READY 0 1 }  { m_axi_C_V_AWADDR ADDR 1 32 }  { m_axi_C_V_AWID ID 1 1 }  { m_axi_C_V_AWLEN LEN 1 32 }  { m_axi_C_V_AWSIZE SIZE 1 3 }  { m_axi_C_V_AWBURST BURST 1 2 }  { m_axi_C_V_AWLOCK LOCK 1 2 }  { m_axi_C_V_AWCACHE CACHE 1 4 }  { m_axi_C_V_AWPROT PROT 1 3 }  { m_axi_C_V_AWQOS QOS 1 4 }  { m_axi_C_V_AWREGION REGION 1 4 }  { m_axi_C_V_AWUSER USER 1 1 }  { m_axi_C_V_WVALID VALID 1 1 }  { m_axi_C_V_WREADY READY 0 1 }  { m_axi_C_V_WDATA DATA 1 512 }  { m_axi_C_V_WSTRB STRB 1 64 }  { m_axi_C_V_WLAST LAST 1 1 }  { m_axi_C_V_WID ID 1 1 }  { m_axi_C_V_WUSER USER 1 1 }  { m_axi_C_V_ARVALID VALID 1 1 }  { m_axi_C_V_ARREADY READY 0 1 }  { m_axi_C_V_ARADDR ADDR 1 32 }  { m_axi_C_V_ARID ID 1 1 }  { m_axi_C_V_ARLEN LEN 1 32 }  { m_axi_C_V_ARSIZE SIZE 1 3 }  { m_axi_C_V_ARBURST BURST 1 2 }  { m_axi_C_V_ARLOCK LOCK 1 2 }  { m_axi_C_V_ARCACHE CACHE 1 4 }  { m_axi_C_V_ARPROT PROT 1 3 }  { m_axi_C_V_ARQOS QOS 1 4 }  { m_axi_C_V_ARREGION REGION 1 4 }  { m_axi_C_V_ARUSER USER 1 1 }  { m_axi_C_V_RVALID VALID 0 1 }  { m_axi_C_V_RREADY READY 1 1 }  { m_axi_C_V_RDATA DATA 0 512 }  { m_axi_C_V_RLAST LAST 0 1 }  { m_axi_C_V_RID ID 0 1 }  { m_axi_C_V_RUSER USER 0 1 }  { m_axi_C_V_RRESP RESP 0 2 }  { m_axi_C_V_BVALID VALID 0 1 }  { m_axi_C_V_BREADY READY 1 1 }  { m_axi_C_V_BRESP RESP 0 2 }  { m_axi_C_V_BID ID 0 1 }  { m_axi_C_V_BUSER USER 0 1 } } }
