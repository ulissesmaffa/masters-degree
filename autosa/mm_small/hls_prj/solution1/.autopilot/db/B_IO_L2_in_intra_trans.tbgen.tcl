...
set C_modelArgList {
	{ local_B_V int 512 regular {array 8 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ local_B_V_address0 sc_out sc_lv 3 signal 0 } 
	{ local_B_V_ce0 sc_out sc_logic 1 signal 0 } 
	{ local_B_V_q0 sc_in sc_lv 512 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "local_B_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "local_B_V", "role": "address0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.kernel0_mux_83_64_1_1_U36", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	local_B_V { ap_memory {  { local_B_V_address0 mem_address 1 3 }  { local_B_V_ce0 mem_ce 1 1 }  { local_B_V_q0 mem_dout 0 512 } } }
