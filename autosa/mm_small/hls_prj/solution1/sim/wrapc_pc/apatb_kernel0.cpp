...
ap_uint<512>* C)
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<512> *gmem_C_pc_buffer = new sc_bv<512>[1];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: gmem_C
				{
					...
					// {
						// celement: C.V(511, 0)
						// {
							sc_lv<512>* C_V_lv0_0_0_1 = new sc_lv<512>[1];
						// }
					// }
					...
					// bitslice(511, 0)
					{
						...
						// celement: C.V(511, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 0; i_0 += 1)
							{
								...
								{
									C_V_lv0_0_0_1[hls_map_index].range(511, 0) = sc_bv<512>(gmem_C_pc_buffer[hls_map_index].range(511, 0));
									hls_map_index++;
								}
							}
						}
					...
					// bitslice(511, 0)
					{
						...
						// celement: C.V(511, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 0; i_0 += 1)
							{
								...
								if (&(C[0]) != NULL) // check the null address if the c port is array or others
								{
									C[i_0] = (C_V_lv0_0_0_1[hls_map_index]).to_string(SC_BIN).c_str();
									hls_map_index++;
								}
							}
						}
	...
	else
	{
		...
		// "gmem_A"
		char* tvin_gmem_A = new char[133];
		aesl_fh.touch(AUTOTB_TVIN_gmem_A);

		// "gmem_B"
		char* tvin_gmem_B = new char[133];
		aesl_fh.touch(AUTOTB_TVIN_gmem_B);

		// "gmem_C"
		char* tvin_gmem_C = new char[133];
		aesl_fh.touch(AUTOTB_TVIN_gmem_C);
		char* tvout_gmem_C = new char[133];
		...
		sc_bv<512>* gmem_A_tvin_wrapc_buffer = new sc_bv<512>[1];
				...
				// celement: A.V(511, 0)
				{
					...
					for (int i_0 = 0; i_0 <= 0; i_0 += 1)
					{
						...
						if (&(A[0]) != NULL) // check the null address if the c port is array or others
						{
							...
							gmem_A_tvin_wrapc_buffer[hls_map_index].range(511, 0) = A_V_tmp_mem.range(511, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		sc_bv<512>* gmem_B_tvin_wrapc_buffer = new sc_bv<512>[1];
				...
				// celement: B.V(511, 0)
				{
					...
					for (int i_0 = 0; i_0 <= 0; i_0 += 1)
					{
						...
						if (&(B[0]) != NULL) // check the null address if the c port is array or others
						{
							...
							gmem_B_tvin_wrapc_buffer[hls_map_index].range(511, 0) = B_V_tmp_mem.range(511, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		sc_bv<512>* gmem_C_tvin_wrapc_buffer = new sc_bv<512>[1];
				...
				// celement: C.V(511, 0)
				{
					...
					for (int i_0 = 0; i_0 <= 0; i_0 += 1)
					{
						...
						if (&(C[0]) != NULL) // check the null address if the c port is array or others
						{
							...
							gmem_C_tvin_wrapc_buffer[hls_map_index].range(511, 0) = C_V_tmp_mem.range(511, 0);
                                 	       hls_map_index++;
						}
					}
				}
...
// [call_c_dut] ---------->
		...
		sc_bv<512>* gmem_C_tvout_wrapc_buffer = new sc_bv<512>[1];
				...
				// celement: C.V(511, 0)
				{
					...
					for (int i_0 = 0; i_0 <= 0; i_0 += 1)
					{
						...
						if (&(C[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<512> C_V_tmp_mem;
							C_V_tmp_mem = (C[i_0]).to_string(2).c_str();
							gmem_C_tvout_wrapc_buffer[hls_map_index].range(511, 0) = C_V_tmp_mem.range(511, 0);
                                 	       hls_map_index++;
						}
					}
				}
