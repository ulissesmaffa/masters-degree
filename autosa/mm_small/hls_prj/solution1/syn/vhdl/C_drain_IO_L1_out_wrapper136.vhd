...
entity C_drain_IO_L1_out_wrapper136 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of C_drain_IO_L1_out_wrapper136 is 
    ...
    signal grp_C_drain_IO_L1_out_fu_26_fifo_C_drain_in_V_V_read : STD_LOGIC;
    signal grp_C_drain_IO_L1_out_fu_26_fifo_C_drain_out_V_V_din : STD_LOGIC_VECTOR (127 downto 0);
    signal grp_C_drain_IO_L1_out_fu_26_fifo_C_drain_out_V_V_write : STD_LOGIC;
    signal grp_C_drain_IO_L1_out_fu_26_fifo_C_drain_local_in_V_read : STD_LOGIC;
...
begin
    grp_C_drain_IO_L1_out_fu_26 : component C_drain_IO_L1_out
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        fifo_C_drain_in_V_V_read => grp_C_drain_IO_L1_out_fu_26_fifo_C_drain_in_V_V_read,
        fifo_C_drain_out_V_V_din => grp_C_drain_IO_L1_out_fu_26_fifo_C_drain_out_V_V_din,
        fifo_C_drain_out_V_V_full_n => fifo_C_drain_out_V_V_full_n,
        fifo_C_drain_out_V_V_write => grp_C_drain_IO_L1_out_fu_26_fifo_C_drain_out_V_V_write,
        fifo_C_drain_local_in_V_dout => fifo_C_drain_local_in_V_dout,
        fifo_C_drain_local_in_V_empty_n => fifo_C_drain_local_in_V_empty_n,
        fifo_C_drain_local_in_V_read => grp_C_drain_IO_L1_out_fu_26_fifo_C_drain_local_in_V_read);
    ...
    fifo_C_drain_in_V_V_read_assign_proc : process(grp_C_drain_IO_L1_out_fu_26_fifo_C_drain_in_V_V_read, ap_CS_fsm_state2)
    begin
    ...
    fifo_C_drain_local_in_V_read_assign_proc : process(grp_C_drain_IO_L1_out_fu_26_fifo_C_drain_local_in_V_read, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            fifo_C_drain_local_in_V_read <= grp_C_drain_IO_L1_out_fu_26_fifo_C_drain_local_in_V_read;
        else 
    ...
    fifo_C_drain_out_V_V_write_assign_proc : process(grp_C_drain_IO_L1_out_fu_26_fifo_C_drain_out_V_V_write, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            fifo_C_drain_out_V_V_write <= grp_C_drain_IO_L1_out_fu_26_fifo_C_drain_out_V_V_write;
        else 
