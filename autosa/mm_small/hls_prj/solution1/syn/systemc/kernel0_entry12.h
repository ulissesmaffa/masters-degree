...
#ifndef _kernel0_entry12_HH_
#define _kernel0_entry12_HH_
...
struct kernel0_entry12 : public sc_module {
    ...
    // Module declarations
    kernel0_entry12(sc_module_name name);
    SC_HAS_PROCESS(kernel0_entry12);
