...
const sc_logic kernel0_entry12::ap_const_logic_1 = sc_dt::Log_1;
const sc_logic kernel0_entry12::ap_const_logic_0 = sc_dt::Log_0;
const sc_lv<1> kernel0_entry12::ap_ST_fsm_state1 = "1";
const sc_lv<32> kernel0_entry12::ap_const_lv32_0 = "00000000000000000000000000000000";
const bool kernel0_entry12::ap_const_boolean_1 = true;

kernel0_entry12::kernel0_entry12(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    apTFilenSS << "kernel0_entry12_sc_trace_" << apTFileNum ++;
...
kernel0_entry12::~kernel0_entry12() {
    if (mVcdFile) 
        sc_close_vcd_trace_file(mVcdFile);

}

void kernel0_entry12::thread_ap_clk_no_reset_() {
...
void kernel0_entry12::thread_A_V_out_blk_n() {
...
void kernel0_entry12::thread_A_V_out_din() {
    A_V_out_din = A_V.read();
}

void kernel0_entry12::thread_A_V_out_write() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, real_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(ap_const_logic_0, A_V_out_full_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, B_V_out_full_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, C_V_out_full_n.read())))) {
...
void kernel0_entry12::thread_B_V_out_blk_n() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, real_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1)))) {
...
void kernel0_entry12::thread_B_V_out_din() {
    B_V_out_din = B_V.read();
}

void kernel0_entry12::thread_B_V_out_write() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, real_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(ap_const_logic_0, A_V_out_full_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, B_V_out_full_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, C_V_out_full_n.read())))) {
...
void kernel0_entry12::thread_C_V_out_blk_n() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, real_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1)))) {
...
void kernel0_entry12::thread_C_V_out_din() {
    C_V_out_din = C_V.read();
}

void kernel0_entry12::thread_C_V_out_write() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, real_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(ap_const_logic_0, A_V_out_full_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, B_V_out_full_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, C_V_out_full_n.read())))) {
...
void kernel0_entry12::thread_ap_CS_fsm_state1() {
    ap_CS_fsm_state1 = ap_CS_fsm.read()[0];
}

void kernel0_entry12::thread_ap_block_state1() {
...
void kernel0_entry12::thread_ap_done() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, real_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(ap_const_logic_0, A_V_out_full_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, B_V_out_full_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, C_V_out_full_n.read())))) {
...
void kernel0_entry12::thread_ap_idle() {
...
void kernel0_entry12::thread_ap_ready() {
    ap_ready = internal_ap_ready.read();
}

void kernel0_entry12::thread_internal_ap_ready() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, real_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(ap_const_logic_0, A_V_out_full_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, B_V_out_full_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, C_V_out_full_n.read())))) {
...
void kernel0_entry12::thread_real_start() {
...
void kernel0_entry12::thread_start_out() {
    start_out = real_start.read();
}

void kernel0_entry12::thread_start_write() {
...
void kernel0_entry12::thread_ap_NS_fsm() {
