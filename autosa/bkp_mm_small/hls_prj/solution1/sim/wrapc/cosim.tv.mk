...
AUTOPILOT_ROOT := /home/ulisses/Tools/Xilinx/Vitis_HLS/2023.1
...
IFLAG += -fPIC
ifndef AP_GCC_PATH
  AP_GCC_PATH := /home/ulisses/Tools/Xilinx/Vitis_HLS/2023.1/tps/lnx64/gcc-8.3.0/bin
endif
...
$(ObjDir)/kernel_host.cpp_pre.cpp.tb.o : kernel_host.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling kernel_host.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/kernel_kernel.cpp_pre.cpp.tb.o : kernel_kernel.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling kernel_kernel.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
