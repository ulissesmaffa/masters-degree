...
set C_modelArgList {
	...
	{ A int 64 regular  }
	{ fifo_A_A_IO_L3_in_serialize int 512 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "gmem_A", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "A","offset": { "type": "dynamic","port_name": "A","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "fifo_A_A_IO_L3_in_serialize", "interface" : "fifo", "bitwidth" : 512, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ m_axi_gmem_A_RFIFONUM sc_in sc_lv 9 signal 0 } 
	...
	{ fifo_A_A_IO_L3_in_serialize_din sc_out sc_lv 512 signal 2 } 
	{ fifo_A_A_IO_L3_in_serialize_num_data_valid sc_in sc_lv 2 signal 2 } 
	{ fifo_A_A_IO_L3_in_serialize_fifo_cap sc_in sc_lv 2 signal 2 } 
	{ fifo_A_A_IO_L3_in_serialize_full_n sc_in sc_logic 1 signal 2 } 
	{ fifo_A_A_IO_L3_in_serialize_write sc_out sc_logic 1 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "m_axi_gmem_A_RFIFONUM", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "gmem_A", "role": "RFIFONUM" }} , 
 	...
 	{ "name": "fifo_A_A_IO_L3_in_serialize_din", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "fifo_A_A_IO_L3_in_serialize", "role": "din" }} , 
 	...
 	{ "name": "fifo_A_A_IO_L3_in_serialize_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fifo_A_A_IO_L3_in_serialize", "role": "full_n" }} , 
 	{ "name": "fifo_A_A_IO_L3_in_serialize_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fifo_A_A_IO_L3_in_serialize", "role": "write" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "fifo_A_A_IO_L3_in_serialize", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
