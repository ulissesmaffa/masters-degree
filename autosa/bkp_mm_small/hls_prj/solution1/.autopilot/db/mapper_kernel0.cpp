...
extern "C" void kernel0(Byte<64>*, Byte<64>*, Byte<64>*, int, int, int);
...
__xlx_C__tmp_vec.push_back(((Byte<64>*)__xlx_apatb_param_C)[i]);
  ...
  // DUT call
  kernel0(__xlx_A__tmp_vec.data(), __xlx_B__tmp_vec.data(), __xlx_C__tmp_vec.data(), __xlx_offset_byte_param_A, __xlx_offset_byte_param_B, __xlx_offset_byte_param_C);
