...
entity kernel0_PE_wrapper_5 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of kernel0_PE_wrapper_5 is 
...
begin
    ...
    fifo_A_PE_1_1_read_assign_proc : process(grp_PE_fu_30_fifo_A_PE_1_12_read, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            fifo_A_PE_1_1_read <= grp_PE_fu_30_fifo_A_PE_1_12_read;
        else 
            fifo_A_PE_1_1_read <= ap_const_logic_0;
        end if; 
    end process;

    fifo_A_PE_1_2_din <= grp_PE_fu_30_fifo_A_PE_1_2_din;

    fifo_A_PE_1_2_write_assign_proc : process(grp_PE_fu_30_fifo_A_PE_1_2_write, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            fifo_A_PE_1_2_write <= grp_PE_fu_30_fifo_A_PE_1_2_write;
        else 
    ...
    fifo_B_PE_1_1_read_assign_proc : process(grp_PE_fu_30_fifo_B_PE_1_1_read, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            fifo_B_PE_1_1_read <= grp_PE_fu_30_fifo_B_PE_1_1_read;
        else 
    ...
    fifo_B_PE_2_1_write_assign_proc : process(grp_PE_fu_30_fifo_B_PE_2_1_write, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            fifo_B_PE_2_1_write <= grp_PE_fu_30_fifo_B_PE_2_1_write;
        else 
    ...
    fifo_C_drain_PE_1_1_write_assign_proc : process(grp_PE_fu_30_fifo_C_drain_PE_1_1_write, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            fifo_C_drain_PE_1_1_write <= grp_PE_fu_30_fifo_C_drain_PE_1_1_write;
        else 
