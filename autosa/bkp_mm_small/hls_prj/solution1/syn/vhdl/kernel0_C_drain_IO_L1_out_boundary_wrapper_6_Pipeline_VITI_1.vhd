...
entity kernel0_C_drain_IO_L1_out_boundary_wrapper_6_Pipeline_VITI_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of kernel0_C_drain_IO_L1_out_boundary_wrapper_6_Pipeline_VITI_1 is 
...
attribute shreg_extract : string;
    ...
    signal trunc_ln849_2_fu_242_p1 : STD_LOGIC_VECTOR (1 downto 0);
    signal trunc_ln849_2_reg_367 : STD_LOGIC_VECTOR (1 downto 0);
    signal local_C_addr_reg_371 : STD_LOGIC_VECTOR (3 downto 0);
    signal data_split_9_reg_377 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln849_reg_363 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                data_split_9_reg_377 <= fifo_C_drain_PE_1_1_dout;
                local_C_addr_reg_371 <= zext_ln859_fu_262_p1(4 - 1 downto 0);
                trunc_ln849_2_reg_367 <= trunc_ln849_2_fu_242_p1;
            end if;
        end if;
    end process;
    ...
    ap_block_pp0_stage0_11001_assign_proc : process(ap_enable_reg_pp0_iter1, fifo_C_drain_PE_1_1_empty_n, icmp_ln849_reg_363)
    begin
                ap_block_pp0_stage0_11001 <= ((icmp_ln849_reg_363 = ap_const_lv1_0) and (fifo_C_drain_PE_1_1_empty_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_enable_reg_pp0_iter1, fifo_C_drain_PE_1_1_empty_n, icmp_ln849_reg_363)
    begin
                ap_block_pp0_stage0_subdone <= ((icmp_ln849_reg_363 = ap_const_lv1_0) and (fifo_C_drain_PE_1_1_empty_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;

        ap_block_state1_pp0_stage0_iter0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state2_pp0_stage0_iter1_assign_proc : process(fifo_C_drain_PE_1_1_empty_n, icmp_ln849_reg_363)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((icmp_ln849_reg_363 = ap_const_lv1_0) and (fifo_C_drain_PE_1_1_empty_n = ap_const_logic_0));
    end process;
    ...
    ap_phi_mux_data_split_5_phi_fu_159_p8_assign_proc : process(icmp_ln849_reg_363_pp0_iter1_reg, trunc_ln849_2_reg_367, data_split_9_reg_377, data_split_fu_283_p1, ap_phi_reg_pp0_iter2_data_split_5_reg_156)
    begin
        if (((trunc_ln849_2_reg_367 = ap_const_lv2_0) and (icmp_ln849_reg_363_pp0_iter1_reg = ap_const_lv1_0))) then 
            ap_phi_mux_data_split_5_phi_fu_159_p8 <= data_split_9_reg_377;
        elsif ((((trunc_ln849_2_reg_367 = ap_const_lv2_2) and (icmp_ln849_reg_363_pp0_iter1_reg = ap_const_lv1_0)) or ((trunc_ln849_2_reg_367 = ap_const_lv2_1) and (icmp_ln849_reg_363_pp0_iter1_reg = ap_const_lv1_0)) or ((trunc_ln849_2_reg_367 = ap_const_lv2_3) and (icmp_ln849_reg_363_pp0_iter1_reg = ap_const_lv1_0)))) then 
    ...
    ap_phi_mux_data_split_6_phi_fu_146_p8_assign_proc : process(local_C_q0, icmp_ln849_reg_363_pp0_iter1_reg, trunc_ln849_2_reg_367, data_split_9_reg_377, ap_phi_reg_pp0_iter2_data_split_6_reg_143)
    begin
        if (((trunc_ln849_2_reg_367 = ap_const_lv2_1) and (icmp_ln849_reg_363_pp0_iter1_reg = ap_const_lv1_0))) then 
            ap_phi_mux_data_split_6_phi_fu_146_p8 <= data_split_9_reg_377;
        elsif ((((trunc_ln849_2_reg_367 = ap_const_lv2_0) and (icmp_ln849_reg_363_pp0_iter1_reg = ap_const_lv1_0)) or ((trunc_ln849_2_reg_367 = ap_const_lv2_2) and (icmp_ln849_reg_363_pp0_iter1_reg = ap_const_lv1_0)) or ((trunc_ln849_2_reg_367 = ap_const_lv2_3) and (icmp_ln849_reg_363_pp0_iter1_reg = ap_const_lv1_0)))) then 
    ...
    ap_phi_mux_data_split_7_phi_fu_133_p8_assign_proc : process(local_C_q0, icmp_ln849_reg_363_pp0_iter1_reg, trunc_ln849_2_reg_367, data_split_9_reg_377, ap_phi_reg_pp0_iter2_data_split_7_reg_130)
    begin
        if (((trunc_ln849_2_reg_367 = ap_const_lv2_2) and (icmp_ln849_reg_363_pp0_iter1_reg = ap_const_lv1_0))) then 
            ap_phi_mux_data_split_7_phi_fu_133_p8 <= data_split_9_reg_377;
        elsif ((((trunc_ln849_2_reg_367 = ap_const_lv2_0) and (icmp_ln849_reg_363_pp0_iter1_reg = ap_const_lv1_0)) or ((trunc_ln849_2_reg_367 = ap_const_lv2_1) and (icmp_ln849_reg_363_pp0_iter1_reg = ap_const_lv1_0)) or ((trunc_ln849_2_reg_367 = ap_const_lv2_3) and (icmp_ln849_reg_363_pp0_iter1_reg = ap_const_lv1_0)))) then 
    ...
    ap_phi_mux_data_split_8_phi_fu_120_p8_assign_proc : process(local_C_q0, icmp_ln849_reg_363_pp0_iter1_reg, trunc_ln849_2_reg_367, data_split_9_reg_377, ap_phi_reg_pp0_iter2_data_split_8_reg_117)
    begin
        if ((((trunc_ln849_2_reg_367 = ap_const_lv2_0) and (icmp_ln849_reg_363_pp0_iter1_reg = ap_const_lv1_0)) or ((trunc_ln849_2_reg_367 = ap_const_lv2_2) and (icmp_ln849_reg_363_pp0_iter1_reg = ap_const_lv1_0)) or ((trunc_ln849_2_reg_367 = ap_const_lv2_1) and (icmp_ln849_reg_363_pp0_iter1_reg = ap_const_lv1_0)))) then 
            ap_phi_mux_data_split_8_phi_fu_120_p8 <= local_C_q0(127 downto 96);
        elsif (((trunc_ln849_2_reg_367 = ap_const_lv2_3) and (icmp_ln849_reg_363_pp0_iter1_reg = ap_const_lv1_0))) then 
            ap_phi_mux_data_split_8_phi_fu_120_p8 <= data_split_9_reg_377;
        else 
    ...
    fifo_C_drain_PE_1_1_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, fifo_C_drain_PE_1_1_empty_n, icmp_ln849_reg_363, ap_block_pp0_stage0)
    begin
    ...
    fifo_C_drain_PE_1_1_read_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln849_reg_363, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln849_reg_363 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            fifo_C_drain_PE_1_1_read <= ap_const_logic_1;
        else 
    ...
    select_ln849_fu_222_p3 <= 
        ...
        c7_fu_82;
    tmp_2_fu_246_p3 <= select_ln849_1_fu_234_p3(2 downto 2);
    tmp_fu_254_p3 <= (trunc_ln849_fu_230_p1 & tmp_2_fu_246_p3);
    trunc_ln849_2_fu_242_p1 <= select_ln849_1_fu_234_p3(2 - 1 downto 0);
