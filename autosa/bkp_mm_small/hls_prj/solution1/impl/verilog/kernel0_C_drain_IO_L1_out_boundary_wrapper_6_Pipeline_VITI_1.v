...
module kernel0_C_drain_IO_L1_out_boundary_wrapper_6_Pipeline_VITI_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [1:0] trunc_ln849_2_fu_242_p1;
reg   [1:0] trunc_ln849_2_reg_367;
reg   [3:0] local_C_addr_reg_371;
reg   [31:0] data_split_9_reg_377;
...
always @ (*) begin
    if (((trunc_ln849_2_reg_367 == 2'd0) & (icmp_ln849_reg_363_pp0_iter1_reg == 1'd0))) begin
        ap_phi_mux_data_split_5_phi_fu_159_p8 = data_split_9_reg_377;
    end else if ((((trunc_ln849_2_reg_367 == 2'd2) & (icmp_ln849_reg_363_pp0_iter1_reg == 1'd0)) | ((trunc_ln849_2_reg_367 == 2'd1) & (icmp_ln849_reg_363_pp0_iter1_reg == 1'd0)) | ((trunc_ln849_2_reg_367 == 2'd3) & (icmp_ln849_reg_363_pp0_iter1_reg == 1'd0)))) begin
...
always @ (*) begin
    if (((trunc_ln849_2_reg_367 == 2'd1) & (icmp_ln849_reg_363_pp0_iter1_reg == 1'd0))) begin
        ap_phi_mux_data_split_6_phi_fu_146_p8 = data_split_9_reg_377;
    end else if ((((trunc_ln849_2_reg_367 == 2'd0) & (icmp_ln849_reg_363_pp0_iter1_reg == 1'd0)) | ((trunc_ln849_2_reg_367 == 2'd2) & (icmp_ln849_reg_363_pp0_iter1_reg == 1'd0)) | ((trunc_ln849_2_reg_367 == 2'd3) & (icmp_ln849_reg_363_pp0_iter1_reg == 1'd0)))) begin
...
always @ (*) begin
    if (((trunc_ln849_2_reg_367 == 2'd2) & (icmp_ln849_reg_363_pp0_iter1_reg == 1'd0))) begin
        ap_phi_mux_data_split_7_phi_fu_133_p8 = data_split_9_reg_377;
    end else if ((((trunc_ln849_2_reg_367 == 2'd0) & (icmp_ln849_reg_363_pp0_iter1_reg == 1'd0)) | ((trunc_ln849_2_reg_367 == 2'd1) & (icmp_ln849_reg_363_pp0_iter1_reg == 1'd0)) | ((trunc_ln849_2_reg_367 == 2'd3) & (icmp_ln849_reg_363_pp0_iter1_reg == 1'd0)))) begin
...
always @ (*) begin
    if ((((trunc_ln849_2_reg_367 == 2'd0) & (icmp_ln849_reg_363_pp0_iter1_reg == 1'd0)) | ((trunc_ln849_2_reg_367 == 2'd2) & (icmp_ln849_reg_363_pp0_iter1_reg == 1'd0)) | ((trunc_ln849_2_reg_367 == 2'd1) & (icmp_ln849_reg_363_pp0_iter1_reg == 1'd0)))) begin
        ap_phi_mux_data_split_8_phi_fu_120_p8 = {{local_C_q0[127:96]}};
    end else if (((trunc_ln849_2_reg_367 == 2'd3) & (icmp_ln849_reg_363_pp0_iter1_reg == 1'd0))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((icmp_ln849_reg_363 == 1'd0) & (fifo_C_drain_PE_1_1_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((icmp_ln849_reg_363 == 1'd0) & (fifo_C_drain_PE_1_1_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((icmp_ln849_reg_363 == 1'd0) & (fifo_C_drain_PE_1_1_empty_n == 1'b0));
end
...
assign tmp_2_fu_246_p3 = select_ln849_1_fu_234_p3[32'd2];

assign tmp_fu_254_p3 = {{trunc_ln849_fu_230_p1}, {tmp_2_fu_246_p3}};

assign trunc_ln849_2_fu_242_p1 = select_ln849_1_fu_234_p3[1:0];

assign trunc_ln849_fu_230_p1 = select_ln849_fu_222_p3[2:0];

assign zext_ln859_fu_262_p1 = tmp_fu_254_p3;

endmodule //kernel0_C_drain_IO_L1_out_boundary_wrapper_6_Pipeline_VITI_1
