...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_101)) begin
        if ((icmp_ln353_fu_78_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((icmp_ln353_fu_78_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln353_fu_84_p2 = (ap_sig_allocacmp_indvar_flatten56_load + 11'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((fifo_B_B_IO_L2_in_0_full_n == 1'b0) | (fifo_B_B_IO_L3_in_serialize_empty_n == 1'b0))) | ((ap_done_reg == 1'b1) & (ap_start_int == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((fifo_B_B_IO_L2_in_0_full_n == 1'b0) | (fifo_B_B_IO_L3_in_serialize_empty_n == 1'b0))) | ((ap_done_reg == 1'b1) & (ap_start_int == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((fifo_B_B_IO_L2_in_0_full_n == 1'b0) | (fifo_B_B_IO_L3_in_serialize_empty_n == 1'b0))) | ((ap_done_reg == 1'b1) & (ap_start_int == 1'b1)));
end
...
assign icmp_ln353_fu_78_p2 = ((ap_sig_allocacmp_indvar_flatten56_load == 11'd1024) ? 1'b1 : 1'b0);
