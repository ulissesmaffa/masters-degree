...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler pe_CONTROL_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { MRI_AXIS_TDATA { O 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { MRI_AXIS_TVALID { O 1 bit } MRI_AXIS_TREADY { I 1 bit } MRI_AXIS_TDEST { O 5 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { MBW_AXIS_TDATA { O 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { MBW_AXIS_TVALID { O 1 bit } MBW_AXIS_TREADY { I 1 bit } MBW_AXIS_TDEST { O 5 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { MBA_AXIS_TDATA { O 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { MBA_AXIS_TVALID { O 1 bit } MBA_AXIS_TREADY { I 1 bit } MBA_AXIS_TDEST { O 5 vector } } \
} "
} else {
...
# RegSlice definition:
set ID 46
set RegSliceName pe_regslice_both
set RegSliceInstName pe_regslice_both_U
set CoreName ap_simcore_pe_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
